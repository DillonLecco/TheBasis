...
const string strMessageMagic = "TheBasis Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TheBasis", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1504680577, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "The Basis start 06092017 developer Dillon Lecco";
        CTransaction txNew;
        txNew.nTime = 1504680577;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1504680577;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 691254 : 691254;
        ...
        assert(block.hashMerkleRoot == uint256("0xcf2bd049683df86dee52a6ee213840953813633a4414dde8e596e0073963558e"));
...
unsigned char pchMessageStart[4] = { 0x7b, 0x8a, 0xe4, 0xfc };
